  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-1.5">
      <div className="flex-1 relative">
        <Search className="absolute left-2 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-stone-500" />
        <input
          type="text"
          value={ticker}
          ...
          placeholder="Ticker..."
          disabled={generating}
          className="w-full pl-7 pr-2 py-1.5 text-xs bg-stone-800 rounded-md text-white placeholder-slate-500 outline-none focus:ring-1 focus:ring-blue-500"
        />
      </div>
      <button
        type="submit"
